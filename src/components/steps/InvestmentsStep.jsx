...
export default function InvestmentsStep({ data, updateData }) {
  ...
  const InvestInput = ({ label, field, placeholder }) => (
    ...
    <div className="animate-fade-in">
      ...
      {hasInvestments && (
        <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm animate-fade-in">
          ...
          <InvestInput label="PPF (Public Provident Fund)" field="ppf" placeholder="e.g. 50,000" />
          <InvestInput label="ELSS Mutual Funds" field="elss" placeholder="e.g. 25,000" />
          <InvestInput label="Life Insurance Premium" field="lic" placeholder="e.g. 15,000" />
          <InvestInput label="Other (Tuition, NSC, 5yr FD, etc.)" field="other" placeholder="e.g. 10,000" />
